<div class="d-flex ms-5">  
    <a href="/clients/create" class="btn btn-outline-success">Add&nbsp;Client</a>
    <form action="/search" method="get">  
        <div class="input-group ms-1">
            <input type="text" name="q" class="form-control bg-white" placeholder="Search the i5..." aria-label="Search the i5..." value= @if(isset($clients)) {{ request()->query('q'); }} @else {{ "" }} @endif>
